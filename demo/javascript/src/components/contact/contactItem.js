...
module.exports = React.createClass({
    ...
    componentDidMount:function(){
        ...
        if (chatUser!=''&&chatUser!=null){
            if (document.getElementById(chatUser)!=null)
                document.getElementById(chatUser).click();
            else{
              var items= document.getElementsByClassName('webim-contact-item');
               if (items.length>0){
                items[0].click();
                }  
            }
    ...
    update: function () {
        ...
        if (Demo.selectedCate !== 'friends' && Demo.selectedCate !== 'strangers') {
            ...
            Demo.selectedName=this.props.nickname;
        } else {
        ...
        return (
            <div id={this.props.id} className={'webim-contact-item' + className} onClick={this.update}>
                ...
                <div className="webim-contact-info">
                    <span className="webim-contact-username">{this.props.nickname}</span>
                </div>
