    ...
    render: function () {
        ...
        return (
            <div className={this.props.show ? 'webim-sign' : 'webim-sign hide'}>
                ...
                <Input placeholder={Demo.lan.username} defaultFocus='true' type='text' ref='name' keydown={this.keyDown} value={username}  />
                <Input placeholder={Demo.lan.password} ref='auth' type='password' value={password} keydown={this.keyDown}/>
