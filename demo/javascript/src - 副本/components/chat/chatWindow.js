...
var Loading = require('../common/chatloading');
...
module.exports = React.createClass({
  ...
  /* update: function (state) {
    ...
    send: function (msg) {
        ...
        //add chat date
        msg.chatDate=new Date().toLocaleString();
    ...
    /*handleWheel:function(e){
        ...
        var clientHeight = this.refs.wrapper.clientHeight; //可视区域高度
        var scrollTop  = this.refs.wrapper.scrollTop;  //滚动条滚动高度
        var  scrollHeight = this.refs.wrapper.scrollHeight; //滚动内容高度
    ...
    render: function () {
        ...
        if (Demo.selectedCate == 'friends') {
            operations.push(<OperationsFriends key='operation_div' ref='operation_div' roomId={this.props.roomId}
                                               admin={this.state.admin} chatId={this.props.id} loading={this.loading}
        ...
        return (
            <div className={'webim-chatwindow ' + this.props.className}>
                <div className='webim-chatwindow-title'>
                    {(Demo.selectedCate == 'chatrooms' || Demo.selectedCate == 'groups') ? Demo.lan.groupMemberLabel : this.props.nickName }
                    <i ref='i'
                ...
                <div id={this.props.id} ref='wrapper' className='webim-chatwindow-msg' >
